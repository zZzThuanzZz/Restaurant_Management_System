...
{
    public partial class frmHienThiKhuyenMai : MauHienThi
    {
        public frmHienThiKhuyenMai()
        {
            InitializeComponent();
        }
        //public void GetData()
        ...
        public void GetData()
        {
            string qry = "SELECT * FROM khuyenmai WHERE giatri LIKE @txtTimKiem"; // Sử dụng tham số truy vấn
        ...
        {
            MainClass.BlurBackground(new frmThemGiaTriKhuyenMai());
            GetData();
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("Insert into khuyenmai(giatri) values('" + dataGridView2.Rows[i].Cells[0].Value + "')", con);//cell 0 là ô đầu tiên
                cmd.ExecuteNonQuery();
            }
            con.Close();
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.CurrentCell.OwningColumn.Name == "dgvSua")
            {
                ...
                {
                    frmThemGiaTriKhuyenMai frm = new frmThemGiaTriKhuyenMai();
            ...
            if (dataGridView1.CurrentCell.OwningColumn.Name == "dgvXoa")
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    string qry = "DELETE FROM khuyenmai WHERE idKM = @id";
        ...
        private void frmHienThiKhuyenMai_Load(object sender, EventArgs e)
        {
