...
{
    public partial class frmHienThiSanPham : MauHienThi
    {
        public frmHienThiSanPham()
        {
            InitializeComponent();
        }

        private void frmHienThiSanPham_Load(object sender, EventArgs e)
        {
        ...
        //public void GetData()
        //{
        //    string qry = "select IDsanpham, Tensanpham, Giasanpham, IDdanhmuc, dm.tendanhmuc from sanpham sp " +
        //        "inner join danhmuc dm on dm.IDdanhmuc = sp.IDdm where Tensanpham like '%" + txtTimKiem.Text + "%'";
        //    ListBox lb = new ListBox();
        //    lb.Items.Add(dgvID);
        //    lb.Items.Add(dgvTen);
        //    lb.Items.Add(dgvGia);
        //    lb.Items.Add(dgvidDM);
        //    lb.Items.Add(dgvDanhMuc);
        ...
        {
            //string qry = "select IDsanpham, Tensanpham, Giasanpham, IDdanhmuc, dm.Tendanhmuc from sanpham sp " +
            //    "inner join danhmuc dm on dm.IDdanhmuc = sp.IDdm where Tensanpham like @txtTimKiem " +
            //    "OR Giasanpham like @txtTimKiem and Tendanhmuc like @txtTimKiem OR";
            string qry = "select IDsanpham, Tensanpham, Giasanpham, IDdanhmuc, dm.Tendanhmuc, trangthai, soluong from sanpham sp " +
             "inner join danhmuc dm on dm.IDdanhmuc = sp.IDdm where Tensanpham like @txtTimKiem " +
             "OR Giasanpham like @txtTimKiem OR trangthai like @txtTimKiem OR Tendanhmuc like @txtTimKiem";
        ...
        public override void btnThem_Click(object sender, EventArgs e)
        {
            ...
            MainClass.BlurBackground(new frmThemSanPham());
            GetData();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.CurrentCell.OwningColumn.Name == "dgvSua")
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    frm.IDdm = Convert.ToInt32(dataGridView1.CurrentRow.Cells["dgvidDM"].Value);
                    //frm.ShowDialog();
            ...
            if (dataGridView1.CurrentCell.OwningColumn.Name == "dgvXoa")
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    string qry = "DELETE FROM sanpham WHERE IDsanpham = @id";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("Insert into sanpham(Tensanpham, Giasanpham, IDdm, trangthai) " +
                    "values(N'" + dataGridView2.Rows[i].Cells[0].Value + "',N'" + dataGridView2.Rows[i].Cells[1].Value + "'," +
                    "N'" + dataGridView2.Rows[i].Cells[2].Value + "',N'" + dataGridView2.Rows[i].Cells[3].Value + "',N'" + dataGridView2.Rows[i].Cells[4].Value + "'" +
                    ")", con);//cell 0 là ô đầu tiên
                cmd.ExecuteNonQuery();
            }
            con.Close();
