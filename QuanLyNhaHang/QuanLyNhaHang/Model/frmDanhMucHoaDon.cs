...
{
    public partial class frmDanhMucHoaDon : MauThem
    {
        ...
        private void LoadData()
        {
            ...
            string qry = @"select MainID, ngay, tenban, tenphucvu, kieuorder, trangthai, tongcong from tblMain
                where trangthai = N'Hoàn thành' OR trangthai = N'Tạm dừng'";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.CurrentCell.OwningColumn.Name == "dgvSua")
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    TrangThai = dataGridView1.CurrentRow.Cells["dgvTrangThai"].Value.ToString();
                    this.Close();
                }
            }
